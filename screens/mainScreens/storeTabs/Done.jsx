...
export default function DoneScreen({
  ...
  const sizes = useMemo(() => {
    ...
    return {
      ...
      personalMarkerBorderWidth: isWebLandscape ? web(3) : mobile(2),
      personalMarkerVP: isWebLandscape ? web(3) : mobile(2),
      personalMarkerHP: isWebLandscape ? web(12) : mobile(6),
      personalMarkerBottomAngleRadius: isWebLandscape ? web(8) : mobile(8),
      personalMarkerFontSize: isWebLandscape ? web(15) : mobile(10),
