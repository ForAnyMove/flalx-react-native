...
export const icons = {
  ...
  // 'job_templates': require('../assets/icon/job_templates.png'),
  // 'job_templates-dark': require('../assets/icon/job_templates-dark.png'),
  // 'subscriptions': require('../assets/icon/subscriptions.png'),
  ...
  method_hyp: require('../assets/icon/card-method.png'),
